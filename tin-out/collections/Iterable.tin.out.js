...
export var stringOf/* (obj:Anything) -> String*/ = TIN_LAMBDA("07c2548d-1a50-480b-aff5-c6b93bae7b3d", function (obj) {
...
export var Iterable = /* [] */(T) => TIN_TYPE("Iterable", "d5a09363-cfa8-4106-8c13-f5c92233c983", (_p0, _p1 = TIN_LAMBDA("17a92483-6250-44a2-bfa7-f7b761dcfd67", function (fn) {
	...
	var string/* String*/ = "";
	var fn/* (t:T) -> Anything*/ = TIN_LAMBDA("8c4dec08-aa8a-4c7f-9eb0-add8ffaaeb0e", function (t) {
		...
		fields: [
			{
				...
				Field: {
					...
					defaultValue: () => {
						return (TIN_LAMBDA("3b85c26e-9898-4f50-ae83-56460deda32e", function (fn) {
							var iterator/* Iterator[T]*/ = ((() => { const _owner = this; return _owner[Iterable._symbol].getIterator.call(_owner,) })());
							var current/* T?*/ = ((() => { const _owner = iterator; return _owner[Iterator._symbol].next.call(_owner,) })())
						}, {
							Type: {
				...
				Field: {
					...
					defaultValue: () => {
						return (TIN_LAMBDA("5e0dded9-177a-4471-9a7a-fb223374edd8", function (separator, left, right) {
							var string/* String*/ = "";
							var fn/* (t:T) -> Anything*/ = TIN_LAMBDA("29322445-4d47-4ff8-9ceb-052aa6472782", function (t) {
								var comma/* String*/ = ((string == "") ? ("") : (separator))
							}, {
								Type: {
									tag: "Lambda",
				...
				Field: {
					...
					defaultValue: () => {
						return (TIN_LAMBDA("64078139-c60c-453e-a684-8eb7a5a19df9", function (pred) {
							var num/* Number*/ = 0;
							return ((() => {
								const _owner = this; return _owner[Iterable._symbol].forEach.call(_owner, TIN_LAMBDA("eb59f262-99ff-4c7d-8deb-fe96fc26077e", function (t) {
									return undefined
								}, {
									Type: {
										tag: "Lambda",
