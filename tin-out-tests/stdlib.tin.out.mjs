...
;
export var Type = _S(typeof _sym !== "undefined" ? _sym : Symbol("Type"), (_p0,_p1,_p2,_p3) => _o({name: _p0,check: _p1,checkIntegrity: _p2,is: _p3}), lazy({isReflectionType: true}), {});
;
export var Field = _S(typeof _sym !== "undefined" ? _sym : Symbol("Field"), (_p0,_p1,_p2) => _o({name: _p0,tpe: _p1,defaultValue: _p2}), lazy({isReflectionType: true}), {});
export var Parameter = _S(typeof _sym !== "undefined" ? _sym : Symbol("Parameter"), (_p0,_p1,_p2) => _o({name: _p0,tpe: _p1,defaultValue: _p2}), lazy({isReflectionType: true}), {});
export var Intersection = (() => { const _left = Type$get(Type); return _A(_left, _S(typeof _sym !== "undefined" ? _sym : Symbol("Intersection"), (_p0,_p1) => _o({left: _p0,right: _p1}), lazy({isReflectionType: true}), {}), true);})();
export var Union = (() => { const _left = Type$get(Type); return _A(_left, _S(typeof _sym !== "undefined" ? _sym : Symbol("Union"), (_p0,_p1) => _o({left: _p0,right: _p1}), lazy({isReflectionType: true}), {}), true);})();
export var Struct = (() => { const _left = Type$get(Type); return _A(_left, _S(typeof _sym !== "undefined" ? _sym : Symbol("Struct"), (_p0) => _o({fields: _p0}), lazy({isReflectionType: true}), {}), true);})();
export var Lambda = (() => { const _left = Type$get(Type); return _A(_left, _S(typeof _sym !== "undefined" ? _sym : Symbol("Lambda"), (_p0,_p1) => _o({params: _p0,resultType: _p1}), lazy({isReflectionType: true}), {}), true);})();
export var RefType = (() => { const _left = Type$get(Type); return _A(_left, _S(typeof _sym !== "undefined" ? _sym : Symbol("RefType"), (_p0) => _o({get: _p0}), lazy({isReflectionType: true}), {}), true);})();
...
throw ((Type$get(Literal).__is_child(type) ) ? (function(){throw Array$of.call('Type', T)(Array(0)([(type[Literal._s].value._) /* as Type$get(T) */]))})() : (function(){return ((Type$get(Union).__is_child(type) ) ? (function(){throw ((() => { var _owner = go(type[Union._s].left._); return _owner[Array._s].and._.call(_owner,go(type[Union._s].right._))})())})() : (function(){throw Array$of.call('Type', T)(Array(0)([]))})()) })()) 
} catch (e) { if (e instanceof Error) { throw e } else { return e } }}, 
				Type("go")._and(Lambda(
